        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <form className="flex-1 space-y-4">
            ...
            <div className="border border-gray-300 rounded-xl p-4 bg-gray-100 space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input placeholder="Especialidad principal" className="input" />
                <input
            ...
            <div className="border border-gray-300 rounded-xl p-4 bg-gray-100 space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <input
                  placeholder="Horario de atención (Ej. 8am - 6pm)"
                  className="input"
                />
              </div>
            </div>
            ...
            <div className="border border-gray-300 rounded-xl p-4 bg-gray-100 space-y-3">
              ...
              <textarea
                rows="4"
                placeholder="Describe tus servicios, experiencia y por qué deberían contratarte"
                className="input"
              />
            </div>
            ...
            <div className="border border-gray-300 rounded-xl p-4 flex items-center justify-between bg-gray-50">
              <div>
                ...
                <p className="text-sm text-gray-500">S/ 8.00 PEN mensual</p>
              </div>
