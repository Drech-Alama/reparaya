import { User, Mail, CreditCard, Pencil } from "lucide-react";
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <form className="flex-1 space-y-4">
            ...
            <div className="border border-gray-300 rounded-xl p-4 bg-gray-100 space-y-3">
              ...
              <input placeholder="Dirección completa" className="input" />
            </div>
            ...
            <div className="border border-gray-300 rounded-xl p-4 bg-gray-100 space-y-2">
              ...
              <label className="flex items-start gap-3 text-sm text-gray-600">
                ...
                <span>
                  ...
                  Ley de Protección de Datos Personales. Mis datos serán
                  utilizados únicamente para la gestión de mi cuenta y servicios
                  contratados.
                </span>
              </label>
            </div>
            ...
            <div className="border border-gray-300 rounded-xl p-4 flex items-center justify-between bg-gray-50">
              <div>
                ...
                <p className="text-sm text-gray-500">S/ 6.00 PEN mensual</p>
              </div>
