...
/* =====================
   STORAGE KEYS
===================== */
const HERO_KEY = "house_solucionesmc";
const PROMOS_KEY = "house_solucionesmc_promotions";
const GALLERY_KEY = "house_solucionesmc_gallery";
...
export default function HouseSolucionesmc() {
    ...
    /* =====================
       HERO
    ===================== */
    const [companyName, setCompanyName] = useState("Soluciones MC");
    ...
    useEffect(() => {
        ...
        if (saved) {
            setCompanyName(saved.companyName || "Soluciones MC");
    ...
    return (
        <>
                ...
                <div className="flex justify-between items-center mb-8">
                    ...
                    {isTecnico && (
                        <button
                            ...
                            className="bg-[var(--color-principal)] text-white px-4 py-2 rounded hover:bg-[var(--color-principal-hover)]"
                        >
                            + Agregar
                        </button>
                    )}
                                    ...
                                    <>
                                        ...
                                        <div className="flex gap-2">
                                            <textarea
                                                ...
                                                rows={2}
                                                className="w-full text-sm border-b outline-none resize-none"
                                            />
                                            <Pencil size={16} />
                                        </div>
                                    </>
            ...
            <WhatsappFloatingButton
                phone="51988888888"
                message="Hola 👋, estoy interesado en los servicios de Soluciones MC"
            />
        </>
    );
}
